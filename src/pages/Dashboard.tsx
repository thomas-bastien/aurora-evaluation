      ...
      <main className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="mb-8">
          <UnifiedOverviewCard
            ...
            completedEvaluations={dashboardData.activeRound === 'screening' 
              ? dashboardData.screeningProgress.completed 
              : dashboardData.pitchingProgress.completed}
            totalEvaluations={dashboardData.activeRound === 'screening' 
              ? dashboardData.screeningProgress.assignments 
              : dashboardData.pitchingProgress.assignments}
