-- Let's add evaluations with proper recommendation values
...
-- Using your existing user ID and proper recommendation values
((SELECT user_id FROM profiles WHERE role = 'admin' LIMIT 1), (SELECT id FROM startups WHERE name = 'TechFlow AI' LIMIT 1), 'submitted',
 ...
 8.2, 'Strong investment opportunity with experienced team and innovative product.', 'yes', 2000000),
...
((SELECT user_id FROM profiles WHERE role = 'admin' LIMIT 1), (SELECT id FROM startups WHERE name = 'CloudScale Systems' LIMIT 1), 'submitted',
 ...
 8.6, 'Exceptional opportunity with best-in-class execution.', 'yes', 5000000),
