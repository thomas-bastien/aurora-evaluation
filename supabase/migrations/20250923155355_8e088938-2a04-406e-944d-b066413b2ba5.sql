-- Use existing lifecycle_stage value that works
INSERT INTO email_templates (name, category, subject_template, body_template, variables, is_active) VALUES
('Juror Evaluation Reminder', 'juror_reminder', '🚀 Aurora Tech Awards - Complete Your {{round_name}} Evaluations', 
...
'["juror_name", "round_name", "completion_rate", "pending_count", "login_link"]', true);