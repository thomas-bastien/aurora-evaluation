-- Create email templates for juror reminders
INSERT INTO email_templates (name, category, subject_template, body_template, variables, lifecycle_stage, evaluation_phase, is_active) VALUES
('Screening Evaluation Reminder', 'evaluation-reminder-screening', '🚀 Aurora Tech Awards - Complete Your Screening Evaluations', 
'<div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
  <div style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); padding: 30px; border-radius: 12px 12px 0 0; text-align: center;">
    ...
    <p style="color: rgba(255,255,255,0.9); margin: 10px 0 0 0; font-size: 16px;">Screening Round - Evaluation Reminder</p>
  </div>
...
'["juror_name", "round_name", "completion_rate", "pending_count", "login_link"]', 'screening', 'screening', true),

('Pitching Evaluation Reminder', 'evaluation-reminder-pitching', '🚀 Aurora Tech Awards - Complete Your Pitching Round Evaluations', 
'<div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
  <div style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); padding: 30px; border-radius: 12px 12px 0 0; text-align: center;">
    <h1 style="color: white; margin: 0; font-size: 28px; font-weight: bold;">Aurora Tech Awards</h1>
    <p style="color: rgba(255,255,255,0.9); margin: 10px 0 0 0; font-size: 16px;">Pitching Round - Evaluation Reminder</p>
  </div>
  ...
  <div style="background: white; padding: 30px; border-radius: 0 0 12px 12px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
    ...
    <p style="color: #666; line-height: 1.6; font-size: 16px;">
      This is a friendly reminder about your pending pitch evaluations in the {{round_name}} round.
    </p>
    ...
    <p style="color: #666; line-height: 1.6; font-size: 16px;">
      Please complete your remaining pitch evaluations to help us identify the final winners. Your feedback is invaluable.
    </p>
...
'["juror_name", "round_name", "completion_rate", "pending_count", "login_link"]', 'pitching', 'pitching', true);